...
:::important
Before proceeding, review the [Slashing Concept](../../../products/eigenlayer/concepts/slashing/slashing-concept.md) content for information on how Operator Sets and Allocations work.
:::
