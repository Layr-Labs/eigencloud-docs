...
| `SLASH_RESOLUTION_DELAY_BLOCKS`  | Amount of blocks between a slash being recorded and the slashed shares becoming clearable for burn or redistribution. | 50400 blocks (~7 days) | Core Protocol: Constant |
