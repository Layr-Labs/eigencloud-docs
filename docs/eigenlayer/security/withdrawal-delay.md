...
The Withdrawal Delay is also referred to as the Escrow Period. Please see Restaking [Escrow Period](/docs/restakers/howto/testnet/restake-testnet-overview#testnet-vs-mainnet-differences) for details on the specific duration.
