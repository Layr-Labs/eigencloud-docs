...
<Tabs groupId="network">
  ...
  <TabItem value="holesky" label="Holesky">
    Holesky is deprecated. New testnet operators should join Hoodi
...
AVS page ([Mainnet](https://app.eigenlayer.xyz/avs/eigenda), [Holesky](https://holesky.eigenlayer.xyz/avs/eigenda), [Hoodi](https://hoodi.eigenlayer.xyz/avs/eigenda)) and sort by `TVL
