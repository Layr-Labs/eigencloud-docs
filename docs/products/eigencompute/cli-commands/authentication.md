...
refer to [Create Authentication Keys](../manage-auth-keys/create-auth-keys.md).
...
[Manage Authentication Keys](../manage-authentication-keys.md).
...
refer to [Manage Authentication Keys](../manage-authentication-keys.md).
