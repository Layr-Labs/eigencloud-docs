...
Telemetry is enabled by default and helps us improve the CLI. We collect:
...
eigenx auth login
```
This helps us understand which features are most used.
...
Duration: 2.3s
```
This helps us identify and fix common issues.
...
Success: true
```
This helps us optimize slow operations.
...
CLI Version: 1.2.3
```
This helps us ensure compatibility.
...
City: San Francisco
```
City-level location only, used for infrastructure planning.
...
❌ **Private Keys** - Your authentication credentials
❌ **Code or Configurations** - Your application source or .env files
❌ **File Paths** - Your project directory structures
❌ **Application Names** - Your specific app names
❌ **Docker Images** - Your image references or content

### Privacy Commitment

- **Anonymous** - No personally identifiable information
- **Secure** - Data transmitted over HTTPS
- **Minimal** - Only what's needed to improve the CLI
- **Optional** - Can be disabled anytime
- **Transparent** - Clear about what's collected
