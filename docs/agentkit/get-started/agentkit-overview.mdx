...
Go to [agents.eigencloud.com](https://agents.eigencloud.com) and sign in with your email.
...
A command-line interface for AgentKit is in development. The CLI will support headless deployments, local file authoring, and scripted agent management. For now, use the [web builder](https://agents.eigencloud.com) to create and manage agents.
:::
