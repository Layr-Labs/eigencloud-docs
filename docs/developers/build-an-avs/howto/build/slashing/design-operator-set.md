...
An [Operator Set](../../../../../products/eigenlayer/concepts/operator-sets/operator-sets-concept.md) is a grouping of different types of work within a single AVS. Each AVS has at least one Operator Set. The 
...
For more information on Operator Sets, refer to [Operator Sets](../../../../../products/eigenlayer/concepts/operator-sets/operator-sets-concept).