...
| Location  | Local OS or organization keyring (macOS Keychain, 1Password, Windows Credential Manager, Linux Secret Service). Stored under `ecloud-<environment>` (for example, `ecloud-mainnet`) |
