...
EigenLayer is a protocol for developers wanting to easily build custom, verifiable, off-chain computation into their applications.
...
## What types of commitments can be built on EigenLayer
...
If your commitment is task based, use the DevKit with the task-based AVS template to get started.
